        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-semibold'>tanushsharma9856@gmail.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-semibold'>Sector 6, Panipat, Haryana, 132103</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <p className='font-semibold'>+91 1234 000 123</p>
                </div>
            </div>
        </div>
